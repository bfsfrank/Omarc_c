...
$_SESSION[current_modifying_sc_id]=$sel_sounds[0];//save the sc id for Modify_sc_bind_ok.php useage
$sql=mysql_query("select * from scenarios where scenariosId = '$_POST[test]'");
$info_sc=mysql_fetch_array($sql);
?>
<html>
<head>
...
<div class="container" align="center" width="75%" >
 ...
 <div id="menu" align="right" style="width:150px; height:98%; overflow-x: hidden;  solid #000000;"> <!-- side sounds layout stroller -->
...
<table id="table1" width="1290" height="630" align="center"  background="M3V2_0000s_0011_Front.jpg" >
    <colgroup>
    </colgroup>
    <tr height=100px>
            <td width="25%" colspan = " 2 "><div id="position17" class="ui-widget-content ui-state-default">
<?php
	if($info_sc[posteriorLeft4] != null ){
		$xman=0;
		for($i =0; $i <= count($session_sounds); $i++){
			$vb=$allinfo[$i];
			$path=$vb[file]; $path_store=$info_sc[posteriorLeft4];
			//$path=str_replace("/","",($path));	$path_store=str_replace("/","",($path_store));
			$path =trim($path); $path_store =trim($path_store);
			if( !strcmp($path,$path_store)){ ?>
               <h6 style="font-style:italic"> Sound <?php echo $i+1;?> <button type='button' title='click to unlink'  class='btn btn-default btn-xs' onClick='$(this).parent().parent().find(  &#39; h6  &#39; ).html(  &#39; P17  &#39; );'><span class='ui-icon ui-icon-close'></span> <h7 id='path17' hidden><?php echo $vb[file];?><?php
			   $xman=1;
			}
        }
		if(0==$xman){
...
<?php
	if($info_sc[posteriorRight4] != null ){
		$xman=0;
		for($i =0; $i <= count($session_sounds); $i++){
			$vb=$allinfo[$i];
			$path=$vb[file]; $path_store=$info_sc[posteriorRight4];
			//$path=str_replace("/","",($path));	$path_store=str_replace("/","",($path_store));
			$path =trim($path); $path_store =trim($path_store);
			if( !strcmp($path,$path_store)){ ?>
               <h6 style="font-style:italic"> Sound <?php echo $i+1;?> <button type='button' title='click to unlink'  class='btn btn-default btn-xs' onClick='$(this).parent().parent().find(  &#39; h6  &#39; ).html(  &#39; P18  &#39; );'><span class='ui-icon ui-icon-close'></span> <h7 id='path18' hidden><?php echo $vb[file];?><?php
			   $xman=1;
			}
        }
		if(0==$xman){
...
<?php
	if($info_sc[anteriorLeft1] != null ){
		$xman=0;
		for ($i =0; $i <= count($session_sounds); $i++){
			$vb=$allinfo[$i];
			$path=$vb[file]; $path_store=$info_sc[anteriorLeft1];
			//$path=str_replace("/","",($path));	$path_store=str_replace("/","",($path_store));
			$path =trim($path); $path_store =trim($path_store);// this part need to compare after the transformation of the two strings, or the result won't be right even the two strings same
			if( !strcmp($path,$path_store)){ ?>
               <h6 style="font-style:italic"> Sound <?php echo $i+1;?> <button type='button' title='click to unlink'  class='btn btn-default btn-xs' onClick='$(this).parent().parent().find(  &#39; h6  &#39; ).html(  &#39; P1  &#39; );'><span class='ui-icon ui-icon-close'></span> <h7 id='path1' hidden><?php echo $vb[file];?><?php 
			   $xman=1;
			}
        }
		if(0==$xman){
...
<?php
	if($info_sc[anteriorRight1] != null ){
		$xman=0;
		for($i =0; $i <= count($session_sounds); $i++){
			$vb=$allinfo[$i];
			$path=$vb[file]; $path_store=$info_sc[anteriorRight1];
			//$path=str_replace("/","",($path));	$path_store=str_replace("/","",($path_store));
			$path =trim($path); $path_store =trim($path_store);
			if( !strcmp($path,$path_store)){ ?>
               <h6 style="font-style:italic"> Sound <?php echo $i+1;?> <button type='button' title='click to unlink'  class='btn btn-default btn-xs' onClick='$(this).parent().parent().find(  &#39; h6  &#39; ).html(  &#39; P2  &#39; );'><span class='ui-icon ui-icon-close'></span> <h7 id='path2' hidden><?php echo $vb[file];?><?php
			   $xman=1;
			}
        }
		if(0==$xman){
...
<?php
	if($info_sc[posteriorLeft1] != null ){
		$xman=0;
		for($i =0; $i <= count($session_sounds); $i++){
			$vb=$allinfo[$i];
			$path=$vb[file]; $path_store=$info_sc[posteriorLeft1];
			//$path=str_replace("/","",($path));	$path_store=str_replace("/","",($path_store));
			$path =trim($path); $path_store =trim($path_store);
			if( !strcmp($path,$path_store)){ ?>
               <h6 style="font-style:italic"> Sound <?php echo $i+1;?> <button type='button' title='click to unlink'  class='btn btn-default btn-xs' onClick='$(this).parent().parent().find(  &#39; h6  &#39; ).html(  &#39; P11  &#39; );'><span class='ui-icon ui-icon-close'></span> <h7 id='path11' hidden><?php echo $vb[file];?></h6><?php
			   $xman=1;
			}
        }
		if(0==$xman){
...
<?php
	if($info_sc[posteriorRight1] != null ){
		$xman=0;
		for($i =0; $i <= count($session_sounds); $i++){
			$vb=$allinfo[$i];
			$path=$vb[file]; $path_store=$info_sc[posteriorRight1];
			//$path=str_replace("/","",($path));	$path_store=str_replace("/","",($path_store));
			$path =trim($path); $path_store =trim($path_store);
			if( !strcmp($path,$path_store)){ ?>
               <h6 style="font-style:italic"> Sound <?php echo $i+1;?> <button type='button' title='click to unlink'  class='btn btn-default btn-xs' onClick='$(this).parent().parent().find(  &#39; h6  &#39; ).html(  &#39; P12  &#39; );'><span class='ui-icon ui-icon-close'></span> <h7 id='path12' hidden><?php echo $vb[file];?><?php
			   $xman=1;
			}
        }
		if(0==$xman){
...
<?php
	if($info_sc[posteriorLeft2] != null ){
		$xman=0;
		for($i =0; $i <= count($session_sounds); $i++){
			$vb=$allinfo[$i];
			$path=$vb[file]; $path_store=$info_sc[posteriorLeft2];
			//$path=str_replace("/","",($path));	$path_store=str_replace("/","",($path_store));
			$path =trim($path); $path_store =trim($path_store);
			if( !strcmp($path,$path_store)){ ?>
               <h6 style="font-style:italic"> Sound <?php echo $i+1;?> <button type='button' title='click to unlink'  class='btn btn-default btn-xs' onClick='$(this).parent().parent().find(  &#39; h6  &#39; ).html(  &#39; P13  &#39; );'><span class='ui-icon ui-icon-close'></span> <h7 id='path13' hidden><?php echo $vb[file];?><?php
			   $xman=1;
			}
        }
		if(0==$xman){
...
<?php
	if($info_sc[posteriorRight2] != null ){
		$xman=0;
		for($i =0; $i <= count($session_sounds); $i++){
			$vb=$allinfo[$i];
			$path=$vb[file]; $path_store=$info_sc[posteriorRight2];
			//$path=str_replace("/","",($path));	$path_store=str_replace("/","",($path_store));
			$path =trim($path); $path_store =trim($path_store);
			if( !strcmp($path,$path_store)){ ?>
               <h6 style="font-style:italic"> Sound <?php echo $i+1;?> <button type='button' title='click to unlink'  class='btn btn-default btn-xs' onClick='$(this).parent().parent().find(  &#39; h6  &#39; ).html(  &#39; P14  &#39; );'><span class='ui-icon ui-icon-close'></span> <h7 id='path14' hidden><?php echo $vb[file];?><?php
			   $xman=1;
			}
        }
		if(0==$xman){
...
<?php
	if($info_sc[anteriorLeft2] != null ){
		$xman=0;
		for($i =0; $i <= count($session_sounds); $i++){
			$vb=$allinfo[$i];
			$path=$vb[file]; $path_store=$info_sc[anteriorLeft2];
			//$path=str_replace("/","",($path));	$path_store=str_replace("/","",($path_store));
			$path =trim($path); $path_store =trim($path_store);
			if( !strcmp($path,$path_store)){ ?>
               <h6 style="font-style:italic"> Sound <?php echo $i+1;?> <button type='button' title='click to unlink'  class='btn btn-default btn-xs' onClick='$(this).parent().parent().find(  &#39; h6  &#39; ).html(  &#39; P3  &#39; );'><span class='ui-icon ui-icon-close'></span> <h7 id='path3' hidden><?php echo $vb[file];?><?php
			   $xman=1;
			}
        }
		if(0==$xman){
...
<?php
	if($info_sc[anteriorRight2] != null ){
		$xman=0;
		for($i =0; $i <= count($session_sounds); $i++){
			$vb=$allinfo[$i];
			$path=$vb[file]; $path_store=$info_sc[anteriorRight2];
			//$path=str_replace("/","",($path));	$path_store=str_replace("/","",($path_store));
			$path =trim($path); $path_store =trim($path_store);
			if( !strcmp($path,$path_store)){ ?>
               <h6 style="font-style:italic"> Sound <?php echo $i+1;?> <button type='button' title='click to unlink'  class='btn btn-default btn-xs' onClick='$(this).parent().parent().find(  &#39; h6  &#39; ).html(  &#39; P4  &#39; );'><span class='ui-icon ui-icon-close'></span> <h7 id='path4' hidden><?php echo $vb[file];?><?php
			   $xman=1;
			}
        }
		if(0==$xman){
...
<?php
	if($info_sc[posteriorLeft3] != null ){
		$xman=0;
		for($i =0; $i <= count($session_sounds); $i++){
			$vb=$allinfo[$i];
			$path=$vb[file]; $path_store=$info_sc[posteriorLeft3];
			//$path=str_replace("/","",($path));	$path_store=str_replace("/","",($path_store));
			$path =trim($path); $path_store =trim($path_store);
			if( !strcmp($path,$path_store)){ ?>
               <h6 style="font-style:italic"> Sound <?php echo $i+1;?> <button type='button' title='click to unlink'  class='btn btn-default btn-xs' onClick='$(this).parent().parent().find(  &#39; h6  &#39; ).html(  &#39; P15  &#39; );'><span class='ui-icon ui-icon-close'></span> <h7 id='path15' hidden><?php echo $vb[file];?><?php
			   $xman=1;
			}
        }
		if(0==$xman){
...
<?php
	if($info_sc[posteriorRight3] != null ){
		$xman=0;
		for($i =0; $i <= count($session_sounds); $i++){
			$vb=$allinfo[$i];
			$path=$vb[file]; $path_store=$info_sc[posteriorRight3];
			//$path=str_replace("/","",($path));	$path_store=str_replace("/","",($path_store));
			$path =trim($path); $path_store =trim($path_store);
			if( !strcmp($path,$path_store)){ ?>
               <h6 style="font-style:italic"> Sound <?php echo $i+1;?> <button type='button' title='click to unlink'  class='btn btn-default btn-xs' onClick='$(this).parent().parent().find(  &#39; h6  &#39; ).html(  &#39; P16  &#39; );'><span class='ui-icon ui-icon-close'></span> <h7 id='path16' hidden><?php echo $vb[file];?><?php
			   $xman=1;
			}
        }
		if(0==$xman){
...
<?php
	if($info_sc[anteriorLeft3] != null ){
		$xman=0;
		for($i =0; $i <= count($session_sounds); $i++){
			$vb=$allinfo[$i];
			$path=$vb[file]; $path_store=$info_sc[anteriorLeft3];
			//$path=str_replace("/","",($path));	$path_store=str_replace("/","",($path_store));
			$path =trim($path); $path_store =trim($path_store);
			if( !strcmp($path,$path_store)){ ?>
               <h6 style="font-style:italic"> Sound <?php echo $i+1;?> <button type='button' title='click to unlink'  class='btn btn-default btn-xs' onClick='$(this).parent().parent().find(  &#39; h6  &#39; ).html(  &#39; P5  &#39; );'><span class='ui-icon ui-icon-close'></span> <h7 id='path5' hidden><?php echo $vb[file];?><?php
			   $xman=1;
			}
        }
		if(0==$xman){
...
<?php
	if($info_sc[anteriorRight3] != null ){
		$xman=0;
		for($i =0; $i <= count($session_sounds); $i++){
			$vb=$allinfo[$i];
			$path=$vb[file]; $path_store=$info_sc[anteriorRight3];
			//$path=str_replace("/","",($path));	$path_store=str_replace("/","",($path_store));
			$path =trim($path); $path_store =trim($path_store);
			if( !strcmp($path,$path_store)){ ?>
               <h6 style="font-style:italic"> Sound <?php echo $i+1;?> <button type='button' title='click to unlink'  class='btn btn-default btn-xs' onClick='$(this).parent().parent().find(  &#39; h6  &#39; ).html(  &#39; P6  &#39; );'><span class='ui-icon ui-icon-close'></span> <h7 id='path6' hidden><?php echo $vb[file];?><?php
			   $xman=1;
			}
        }
		if(0==$xman){
...
<?php
	if($info_sc[posteriorLeft5] != null ){
		$xman=0;
		for($i =0; $i <= count($session_sounds); $i++){
			$vb=$allinfo[$i];
			$path=$vb[file]; $path_store=$info_sc[posteriorLeft5];
			//$path=str_replace("/","",($path));	$path_store=str_replace("/","",($path_store));
			$path =trim($path); $path_store =trim($path_store);
			if( !strcmp($path,$path_store)){ ?>
               <h6 style="font-style:italic"> Sound <?php echo $i+1;?> <button type='button' title='click to unlink'  class='btn btn-default btn-xs' onClick='$(this).parent().parent().find(  &#39; h6  &#39; ).html(  &#39; P19  &#39; );'><span class='ui-icon ui-icon-close'></span> <h7 id='path19' hidden><?php echo $vb[file];?><?php
			   $xman=1;
			}
        }
		if(0==$xman){
...
<?php
	if($info_sc[posteriorRight5] != null ){
		$xman=0;
		for($i =0; $i <= count($session_sounds); $i++){
			$vb=$allinfo[$i];
			$path=$vb[file]; $path_store=$info_sc[posteriorRight5];
			//$path=str_replace("/","",($path));	$path_store=str_replace("/","",($path_store));
			$path =trim($path); $path_store =trim($path_store);
			if( !strcmp($path,$path_store)){ ?>
               <h6 style="font-style:italic"> Sound <?php echo $i+1;?> <button type='button' title='click to unlink'  class='btn btn-default btn-xs' onClick='$(this).parent().parent().find(  &#39; h6  &#39; ).html(  &#39; P20  &#39; );'><span class='ui-icon ui-icon-close'></span> <h7 id='path20' hidden><?php echo $vb[file];?><?php
			   $xman=1;
			}
        }
		if(0==$xman){
...
<?php
	if($info_sc[posteriorLeft6] != null ){
		$xman=0;
		for($i =0; $i <= count($session_sounds); $i++){
			$vb=$allinfo[$i];
			$path=$vb[file]; $path_store=$info_sc[posteriorLeft6];
			//$path=str_replace("/","",($path));	$path_store=str_replace("/","",($path_store));
			$path =trim($path); $path_store =trim($path_store);
			if( !strcmp($path,$path_store)){ ?>
               <h6 style="font-style:italic"> Sound <?php echo $i+1;?> <button type='button' title='click to unlink'  class='btn btn-default btn-xs' onClick='$(this).parent().parent().find(  &#39; h6  &#39; ).html(  &#39; P21  &#39; );'><span class='ui-icon ui-icon-close'></span> <h7 id='path21' hidden><?php echo $vb[file];?><?php
			   $xman=1;
			}
        }
		if(0==$xman){
...
<?php
	if($info_sc[posteriorRight6] != null ){
		$xman=0;
		for($i =0; $i <= count($session_sounds); $i++){
			$vb=$allinfo[$i];
			$path=$vb[file]; $path_store=$info_sc[posteriorRight6];
			//$path=str_replace("/","",($path));	$path_store=str_replace("/","",($path_store));
			$path =trim($path); $path_store =trim($path_store);
			if( !strcmp($path,$path_store)){ ?>
               <h6 style="font-style:italic"> Sound <?php echo $i+1;?> <button type='button' title='click to unlink'  class='btn btn-default btn-xs' onClick='$(this).parent().parent().find(  &#39; h6  &#39; ).html(  &#39; P22  &#39; );'><span class='ui-icon ui-icon-close'></span> <h7 id='path22' hidden><?php echo $vb[file];?><?php
			   $xman=1;
			}
        }
		if(0==$xman){
...
<?php
	if($info_sc[anteriorLeft4] != null ){
		$xman=0;
		for($i =0; $i <= count($session_sounds); $i++){
			$vb=$allinfo[$i];
			$path=$vb[file]; $path_store=$info_sc[anteriorLeft4];
			//$path=str_replace("/","",($path));	$path_store=str_replace("/","",($path_store));
			$path =trim($path); $path_store =trim($path_store);
			if( !strcmp($path,$path_store)){ ?>
               <h6 style="font-style:italic"> Sound <?php echo $i+1;?> <button type='button' title='click to unlink'  class='btn btn-default btn-xs' onClick='$(this).parent().parent().find(  &#39; h6  &#39; ).html(  &#39; P7  &#39; );'><span class='ui-icon ui-icon-close'></span> <h7 id='path7' hidden><?php echo $vb[file];?><?php
			   $xman=1;
			}
        }
		if(0==$xman){
...
<?php
	if($info_sc[anteriorRight4] != null ){
		$xman=0;
		for($i =0; $i <= count($session_sounds); $i++){
			$vb=$allinfo[$i];
			$path=$vb[file]; $path_store=$info_sc[anteriorRight4];
			//$path=str_replace("/","",($path));	$path_store=str_replace("/","",($path_store));
			$path =trim($path); $path_store =trim($path_store);
			if( !strcmp($path,$path_store)){ ?>
               <h6 style="font-style:italic"> Sound <?php echo $i+1;?> <button type='button' title='click to unlink'  class='btn btn-default btn-xs' onClick='$(this).parent().parent().find(  &#39; h6  &#39; ).html(  &#39; P8  &#39; );'><span class='ui-icon ui-icon-close'></span> <h7 id='path8' hidden><?php echo $vb[file];?><?php
			   $xman=1;
			}
        }
		if(0==$xman){
...
<?php
	if($info_sc[posteriorLeft7] != null ){
		$xman=0;
		for($i =0; $i <= count($session_sounds); $i++){
			$vb=$allinfo[$i];
			$path=$vb[file]; $path_store=$info_sc[posteriorLeft7];
			//$path=str_replace("/","",($path));	$path_store=str_replace("/","",($path_store));
			$path =trim($path); $path_store =trim($path_store);
			if( !strcmp($path,$path_store)){ ?>
               <h6 style="font-style:italic"> Sound <?php echo $i+1;?> <button type='button' title='click to unlink'  class='btn btn-default btn-xs' onClick='$(this).parent().parent().find(  &#39; h6  &#39; ).html(  &#39; P23  &#39; );'><span class='ui-icon ui-icon-close'></span> <h7 id='path23' hidden><?php echo $vb[file];?><?php
			   $xman=1;
			}
        }
		if(0==$xman){
...
<?php
	if($info_sc[posteriorRight7] != null ){
		$xman=0;
		for($i =0; $i <= count($session_sounds); $i++){
			$vb=$allinfo[$i];
			$path=$vb[file]; $path_store=$info_sc[posteriorRight7];
			//$path=str_replace("/","",($path));	$path_store=str_replace("/","",($path_store));
			$path =trim($path); $path_store =trim($path_store);
			if( !strcmp($path,$path_store)){ ?>
               <h6 style="font-style:italic"> Sound <?php echo $i+1;?> <button type='button' title='click to unlink'  class='btn btn-default btn-xs' onClick='$(this).parent().parent().find(  &#39; h6  &#39; ).html(  &#39; P24  &#39; );'><span class='ui-icon ui-icon-close'></span> <h7 id='path24' hidden><?php echo $vb[file];?><?php
			   $xman=1;
			}
        }
		if(0==$xman){
...
<?php
	if($info_sc[anteriorLeft5] != null ){
		$xman=0;
		for($i =0; $i <= count($session_sounds); $i++){
			$vb=$allinfo[$i];
			$path=$vb[file]; $path_store=$info_sc[anteriorLeft5];
			//$path=str_replace("/","",($path));	$path_store=str_replace("/","",($path_store));
			$path =trim($path); $path_store =trim($path_store);
			if( !strcmp($path,$path_store)){ ?>
               <h6 style="font-style:italic"> Sound <?php echo $i+1;?> <button type='button' title='click to unlink'  class='btn btn-default btn-xs' onClick='$(this).parent().parent().find(  &#39; h6  &#39; ).html(  &#39; P9  &#39; );'><span class='ui-icon ui-icon-close'></span> <h7 id='path9' hidden><?php echo $vb[file];?><?php
			   $xman=1;
			}
        }
		if(0==$xman){
...
<?php
	if($info_sc[anteriorRight5] != null ){
		$xman=0;
		for($i =0; $i <= count($session_sounds); $i++){
			$vb=$allinfo[$i];
			$path=$vb[file]; $path_store=$info_sc[anteriorRight5];
			//$path=str_replace("/","",($path));	$path_store=str_replace("/","",($path_store));
			$path =trim($path); $path_store =trim($path_store);
			if( !strcmp($path,$path_store)){ ?>
               <h6 style="font-style:italic"> Sound <?php echo $i+1;?> <button type='button' title='click to unlink'  class='btn btn-default btn-xs' onClick='$(this).parent().parent().find(  &#39; h6  &#39; ).html(  &#39; P10  &#39; );'><span class='ui-icon ui-icon-close'></span> <h7 id='path10' hidden><?php echo $vb[file];?><?php
			   $xman=1;
			}
        }
		if(0==$xman){
...
<?php
	if($info_sc[posteriorLeft8] != null ){
		$xman=0;
		$xman=0;
		for($i =0; $i <= count($session_sounds); $i++){
			$vb=$allinfo[$i];
			$path=$vb[file]; $path_store=$info_sc[posteriorLeft8];
			//$path=str_replace("/","",($path));	$path_store=str_replace("/","",($path_store));
			$path =trim($path); $path_store =trim($path_store);
			if( !strcmp($path,$path_store)){ ?>
               <h6 style="font-style:italic"> Sound <?php echo $i+1;?> <button type='button' title='click to unlink'  class='btn btn-default btn-xs' onClick='$(this).parent().parent().find(  &#39; h6  &#39; ).html(  &#39; P25  &#39; );'><span class='ui-icon ui-icon-close'></span> <h7 id='path25' hidden><?php echo $vb[file];?><?php
			   $xman=1;
			}
        }
		if(0==$xman){
...
<?php
	if($info_sc[posteriorRight8] != null ){
		$xman=0;
		$xman=0;
		for($i =0; $i <= count($session_sounds); $i++){
			$vb=$allinfo[$i];
			$path=$vb[file]; $path_store=$info_sc[posteriorRight8];
			//$path=str_replace("/","",($path));	$path_store=str_replace("/","",($path_store));
			$path =trim($path); $path_store =trim($path_store);
			if( !strcmp($path,$path_store)){ ?>
               <h6 style="font-style:italic"> Sound <?php echo $i+1;?> <button type='button' title='click to unlink'  class='btn btn-default btn-xs' onClick='$(this).parent().parent().find(  &#39; h6  &#39; ).html(  &#39; P26  &#39; );'><span class='ui-icon ui-icon-close'></span> <h7 id='path26' hidden><?php echo $vb[file];?></h6><?php
			   $xman=1;
			}
        }
		if(0==$xman){
