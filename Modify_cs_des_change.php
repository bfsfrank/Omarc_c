...
$_SESSION[current_modifying_cs_id]=$sel_sounds[0];//save the cs id for Modify_cs_ok.php useage
$sql=mysql_query("select * from case_study where id = '$_POST[test]'");
...
<form name="form1" method="post" action="Modify_cs_des_ok.php">
<body>
...
<tr>
        ...
        <td width="200" height="60"><?php echo $info[description]; ?>
        </td>
        </tr>
      <tr>
