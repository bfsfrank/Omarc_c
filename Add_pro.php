...
<table width="776" border="0" align="center" cellpadding="0" cellspacing="0" class="tableBorder">
  ...
  <tr>
    <td height="510" valign="top" style="padding:5px;"><table width="98%" height="487"  border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td height="22" valign="top" class="word_orange">Add a New Professor &gt;&gt;&gt;</td>
      </tr>
      <tr>
...
</table>  <form name="form1" method="post" action="Add_pro_ok.php">
  ...
  <tr align="center">
    ...
    <tr>
      ...
      <td align="left"><input name="pwd1" type="password" id="pwd1" size="30"></td>
        ...
        <tr>
      <td align="left" style="padding:5px;">Full Name:</td>
